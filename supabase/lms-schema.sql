...
BEGIN
  FOR r IN
    ...
    [
      ...
      {"code":"AAC","phase_slug":"phase-1","phase_label":"Phase 1","phase_title":"LLM Foundations","phase_meta":"Modules 1–3","phase_sort":1,"mod":1,"mod_title":"How LLMs Work","quiz":true,"assign":true,"topics":["Tokens & embeddings","Transformers & context windows","Temperature, Top-P & Top-K sampling"]},
      {"code":"AAC","phase_slug":"phase-1","phase_label":"Phase 1","phase_title":"LLM Foundations","phase_meta":"Modules 1–3","phase_sort":1,"mod":2,"mod_title":"Prompt Engineering","quiz":true,"assign":true,"topics":["Zero-shot & few-shot prompting","Chain-of-thought reasoning","System prompts & reusable templates"]},
      {"code":"AAC","phase_slug":"phase-1","phase_label":"Phase 1","phase_title":"LLM Foundations","phase_meta":"Modules 1–3","phase_sort":1,"mod":3,"mod_title":"Function Calling & Open Source LLMs","quiz":true,"assign":true,"topics":["Function calling & structured outputs","Pydantic schemas for LLM responses","Ollama, Llama 3 & Mistral locally"]},
      {"code":"AAC","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Agent Engineering","phase_meta":"Modules 4–8","phase_sort":2,"mod":4,"mod_title":"LangChain Core","quiz":true,"assign":true,"topics":["LCEL pipelines","Chains & output parsers","Runnable sequences & composition"]},
      {"code":"AAC","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Agent Engineering","phase_meta":"Modules 4–8","phase_sort":2,"mod":5,"mod_title":"AI Agents","quiz":true,"assign":true,"topics":["ReAct agent loop","Planning & reflection patterns","Tool use & web search"]},
      {"code":"AAC","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Agent Engineering","phase_meta":"Modules 4–8","phase_sort":2,"mod":6,"mod_title":"RAG Systems","quiz":true,"assign":true,"topics":["ChromaDB & Pinecone vector stores","Chunking & embedding strategies","Hybrid search for better retrieval"]},
      {"code":"AAC","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Agent Engineering","phase_meta":"Modules 4–8","phase_sort":2,"mod":7,"mod_title":"Memory Systems","quiz":true,"assign":false,"topics":["Buffer memory for short context","Vector memory for long-term recall","Persistent session storage"]},
      {"code":"AAC","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Agent Engineering","phase_meta":"Modules 4–8","phase_sort":2,"mod":8,"mod_title":"LangGraph","quiz":true,"assign":true,"topics":["State machines & cyclic workflows","Human-in-the-loop checkpoints","State persistence & recovery"]},
      {"code":"AAC","phase_slug":"phase-3","phase_label":"Phase 3","phase_title":"Multi-Agent & Production","phase_meta":"Modules 9–12","phase_sort":3,"mod":9,"mod_title":"Multi-Agent Systems","quiz":true,"assign":true,"topics":["CrewAI role-based teams","AutoGen agent collaboration","Supervisor delegation pattern"]},
      {"code":"AAC","phase_slug":"phase-3","phase_label":"Phase 3","phase_title":"Multi-Agent & Production","phase_meta":"Modules 9–12","phase_sort":3,"mod":10,"mod_title":"Observability & Evaluation","quiz":true,"assign":true,"topics":["LangSmith tracing & debugging","LangFuse & AgentOps monitoring","Agent evaluation metrics"]},
      {"code":"AAC","phase_slug":"phase-3","phase_label":"Phase 3","phase_title":"Multi-Agent & Production","phase_meta":"Modules 9–12","phase_sort":3,"mod":11,"mod_title":"Deployment","quiz":true,"assign":true,"topics":["FastAPI agent endpoints","Docker & Docker Compose","Streaming responses to clients"]},
      {"code":"AAC","phase_slug":"phase-3","phase_label":"Phase 3","phase_title":"Multi-Agent & Production","phase_meta":"Modules 9–12","phase_sort":3,"mod":12,"mod_title":"Cloud AI","quiz":true,"assign":true,"topics":["AWS Bedrock & Azure OpenAI overview","Cost optimization strategies","Security & access control for agents"]},

      {"code":"AWS","phase_slug":"phase-1","phase_label":"Phase 1","phase_title":"AWS Foundations","phase_meta":"Weeks 1–4 · Modules 1–4","phase_sort":1,"mod":1,"mod_title":"Cloud Computing Fundamentals","quiz":true,"assign":true,"topics":["What is cloud computing?","IaaS, PaaS & SaaS service models","Public, private & hybrid cloud","AWS global infrastructure","Regions & Availability Zones","AWS Shared Responsibility Model"]},
      {"code":"AWS","phase_slug":"phase-1","phase_label":"Phase 1","phase_title":"AWS Foundations","phase_meta":"Weeks 1–4 · Modules 1–4","phase_sort":1,"mod":2,"mod_title":"IAM & Security","quiz":true,"assign":true,"topics":["IAM users, groups & roles","IAM policies & permission boundaries","MFA & credential security","AWS Organizations basics"]},
      {"code":"AWS","phase_slug":"phase-1","phase_label":"Phase 1","phase_title":"AWS Foundations","phase_meta":"Weeks 1–4 · Modules 1–4","phase_sort":1,"mod":3,"mod_title":"Compute Services","quiz":true,"assign":true,"topics":["Amazon EC2 instance types & AMIs","EBS volumes & snapshots","Placement groups","Launch templates"]},
      {"code":"AWS","phase_slug":"phase-1","phase_label":"Phase 1","phase_title":"AWS Foundations","phase_meta":"Weeks 1–4 · Modules 1–4","phase_sort":1,"mod":4,"mod_title":"Storage Services","quiz":true,"assign":true,"topics":["Amazon S3 & storage classes","EBS vs EFS","Lifecycle policies & versioning","Encryption at rest & in transit"]},
      {"code":"AWS","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Core Architecture","phase_meta":"Weeks 5–8 · Modules 5–8","phase_sort":2,"mod":5,"mod_title":"Networking & VPC","quiz":true,"assign":true,"topics":["VPCs, subnets & route tables","Internet Gateway & NAT Gateway","Security groups vs NACLs","Public & private tier design"]},
      {"code":"AWS","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Core Architecture","phase_meta":"Weeks 5–8 · Modules 5–8","phase_sort":2,"mod":6,"mod_title":"Load Balancing & Auto Scaling","quiz":true,"assign":true,"topics":["Application Load Balancer (ALB)","Network Load Balancer (NLB)","Target groups & health checks","Auto Scaling groups & policies"]},
      {"code":"AWS","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Core Architecture","phase_meta":"Weeks 5–8 · Modules 5–8","phase_sort":2,"mod":7,"mod_title":"Databases","quiz":true,"assign":true,"topics":["Amazon RDS & Multi-AZ","DynamoDB fundamentals","ElastiCache for performance","Amazon Aurora overview"]},
      {"code":"AWS","phase_slug":"phase-2","phase_label":"Phase 2","phase_title":"Core Architecture","phase_meta":"Weeks 5–8 · Modules 5–8","phase_sort":2,"mod":8,"mod_title":"DNS & CDN","quiz":true,"assign":true,"topics":["Route 53 routing policies","CloudFront CDN delivery","AWS Certificate Manager (ACM)"]},
      {"code":"AWS","phase_slug":"phase-3","phase_label":"Phase 3","phase_title":"Production Architecture","phase_meta":"Weeks 9–12 · Modules 9–12","phase_sort":3,"mod":9,"mod_title":"Serverless AWS","quiz":true,"assign":true,"topics":["AWS Lambda & execution models","API Gateway REST APIs","SNS & SQS messaging","EventBridge event routing"]},
      {"code":"AWS","phase_slug":"phase-3","phase_label":"Phase 3","phase_title":"Production Architecture","phase_meta":"Weeks 9–12 · Modules 9–12","phase_sort":3,"mod":10,"mod_title":"Monitoring & Cost Optimization","quiz":true,"assign":true,"topics":["CloudWatch metrics, logs & alarms","CloudTrail auditing","AWS Config compliance","Budgets, Cost Explorer & Trusted Advisor"]},
      {"code":"AWS","phase_slug":"phase-3","phase_label":"Phase 3","phase_title":"Production Architecture","phase_meta":"Weeks 9–12 · Modules 9–12","phase_sort":3,"mod":11,"mod_title":"Infrastructure as Code","quiz":true,"assign":true,"topics":["CloudFormation templates & stacks","Terraform on AWS","State management & modules"]},
      {"code":"AWS","phase_slug":"phase-3","phase_label":"Phase 3","phase_title":"Production Architecture","phase_meta":"Weeks 9–12 · Modules 9–12","phase_sort":3,"mod":12,"mod_title":"HA, DR & SAA-C03 Exam Preparation","quiz":true,"assign":true,"topics":["Multi-AZ & multi-region patterns","Backup, restore & DR planning (RTO/RPO)","AWS Well-Architected Framework","SAA-C03 exam domains & scenario questions","Architecture trade-offs: security, cost, reliability"]},
  ...
  -- Retire legacy AAC modules from the old 10-module layout (now 12 modules)
  UPDATE public.program_modules
  SET is_published = false, updated_at = NOW()
  WHERE course_id IN (SELECT id FROM public.courses WHERE upper(code) = 'AAC')
    AND module_number > 12;
